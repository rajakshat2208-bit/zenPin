...
def seed_demo_ideas():
    ...
    try:
        ...
        demo = [
            # Interior Design
            ("Japandi Living Room",          "Interior Design",     "https://loremflickr.com/500/700/interior,livingroom?lock=1",   3,5,4),
            ("Wabi-Sabi Bedroom",            "Interior Design",     "https://loremflickr.com/500/720/interior,bedroom?lock=2",       3,5,4),
            ("Curved Plaster Arch",          "Interior Design",     "https://loremflickr.com/500/680/interior,homedecor?lock=3",     5,5,3),
            ("Boho Living Space",            "Interior Design",     "https://loremflickr.com/500/740/interior,livingroom?lock=4",    2,4,4),
            # Workspace
            ("Minimal Oak Desk",             "Workspace",           "https://loremflickr.com/500/700/workspace,desk?lock=1",        2,4,5),
            ("Dual Monitor Setup",           "Workspace",           "https://loremflickr.com/500/720/workspace,office?lock=2",      3,4,5),
            ("Creative Studio",              "Workspace",           "https://loremflickr.com/500/680/workspace,desk?lock=3",        2,4,4),
            # Architecture
            ("Brutalist Staircase",          "Architecture",        "https://loremflickr.com/500/700/architecture,building?lock=1", 4,5,2),
            ("Glass Tower Blue Hour",        "Architecture",        "https://loremflickr.com/500/750/architecture,modern?lock=2",   2,5,2),
            ("Spiral Staircase",             "Architecture",        "https://loremflickr.com/500/700/architecture,design?lock=3",   3,5,2),
            # Art
            ("Abstract Art Study",           "Art",                 "https://loremflickr.com/500/700/art,painting?lock=1",          3,5,2),
            ("Ink Wash on Paper",            "Art",                 "https://loremflickr.com/500/750/art,creative?lock=2",           4,5,2),
            ("Watercolour Botanical",        "Art",                 "https://loremflickr.com/500/720/art,watercolor?lock=3",         3,4,3),
            # Nature
            ("Forest Morning Mist",          "Nature",              "https://loremflickr.com/500/700/nature,forest?lock=1",          3,5,2),
            ("Desert Golden Hour",           "Nature",              "https://loremflickr.com/500/720/nature,landscape?lock=2",       1,4,2),
            ("Wildflower Meadow",            "Nature",              "https://loremflickr.com/500/700/nature,flowers?lock=3",         1,4,3),
            # Food
            ("Sourdough Scoring Art",        "Food",                "https://loremflickr.com/500/700/food,bread?lock=1",             3,4,5),
            ("Japanese Breakfast",           "Food",                "https://loremflickr.com/500/720/food,japanese?lock=2",          2,4,5),
            ("Matcha Latte Art",             "Food",                "https://loremflickr.com/500/700/food,coffee?lock=3",            1,4,4),
            # Fashion
            ("Street Style Look",            "Fashion",             "https://loremflickr.com/500/700/fashion,style?lock=1",          2,4,3),
            ("Editorial in Fog",             "Fashion",             "https://loremflickr.com/500/750/fashion,clothing?lock=2",       3,5,2),
            ("Summer Minimal Fit",           "Fashion",             "https://loremflickr.com/500/680/fashion,outfit?lock=3",         2,4,3),
            # Travel
            ("Fjord at Dusk",                "Travel",              "https://loremflickr.com/500/700/travel,landscape?lock=1",       1,5,3),
            ("Old Town Streets",             "Travel",              "https://loremflickr.com/500/720/travel,city?lock=2",            1,4,3),
            ("Salt Flats Mirror",            "Travel",              "https://loremflickr.com/500/680/travel,destination?lock=3",     1,5,2),
            ("Bali Rice Terraces",           "Travel",              "https://loremflickr.com/500/760/travel,bali?lock=4",            1,4,3),
            # Tech
            ("Circuit Board Abstract",       "Tech",                "https://loremflickr.com/500/700/technology,computer?lock=1",    4,4,4),
            ("LED Neon Workshop",            "Tech",                "https://loremflickr.com/500/720/technology,digital?lock=2",     4,5,3),
            # Anime
            ("Cyberpunk Cityscape",          "Anime",               "https://loremflickr.com/500/700/anime,japan?lock=1",            2,5,3),
            ("Aesthetic Anime Room",         "Anime",               "https://loremflickr.com/500/700/anime,manga?lock=2",            1,5,3),
            ("Neon City Vibes",              "Anime",               "https://loremflickr.com/500/750/anime,japan?lock=3",            2,5,3),
            # Cars
            ("Supercar Street Photo",        "Cars",                "https://loremflickr.com/500/700/car,automobile?lock=1",         2,5,4),
            ("Classic Car Garage",           "Cars",                "https://loremflickr.com/500/720/car,supercar?lock=2",           2,4,3),
            ("Sports Car at Dusk",           "Cars",                "https://loremflickr.com/500/680/car,automobile?lock=3",         1,5,3),
            ("Vintage Restore",              "Cars",                "https://loremflickr.com/500/720/car,vintage?lock=4",            3,4,3),
            # Bikes
            ("Sports Bike at Sunset",        "Bikes",               "https://loremflickr.com/500/700/motorcycle,motorbike?lock=1",   2,5,3),
            ("Cafe Racer Custom",            "Bikes",               "https://loremflickr.com/500/750/motorcycle,bike?lock=2",        4,5,3),
            ("Adventure Trail Ride",         "Bikes",               "https://loremflickr.com/500/680/motorcycle,motorbike?lock=3",   2,4,3),
            # Scenery
            ("Mountain Lake Reflection",     "Scenery",             "https://loremflickr.com/500/700/landscape,mountain?lock=1",     1,5,2),
            ("Aurora Night Sky",             "Scenery",             "https://loremflickr.com/500/750/landscape,aurora?lock=2",       1,5,2),
            ("Tropical Waterfall",           "Scenery",             "https://loremflickr.com/500/700/landscape,waterfall?lock=3",    1,5,2),
            # Gaming
            ("RGB Gaming Setup",             "Gaming",              "https://loremflickr.com/500/700/gaming,computer?lock=1",        3,5,4),
            ("Retro Console Collection",     "Gaming",              "https://loremflickr.com/500/720/gaming,videogame?lock=2",       2,4,4),
            # Ladies Accessories
            ("Gold Bangle Stack",            "Ladies Accessories",  "https://loremflickr.com/500/700/jewelry,accessories?lock=1",    1,5,4),
            ("Pearl Earrings",               "Ladies Accessories",  "https://loremflickr.com/500/720/jewelry,earrings?lock=2",       1,5,4),
            ("Layered Necklaces",            "Ladies Accessories",  "https://loremflickr.com/500/700/jewelry,necklace?lock=3",       1,5,4),
            ("Statement Rings",              "Ladies Accessories",  "https://loremflickr.com/500/700/jewelry,rings?lock=4",          1,4,4),
        ]
